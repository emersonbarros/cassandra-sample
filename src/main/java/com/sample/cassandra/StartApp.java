...
public class StartApp {
  public static void main(String[] args) {
    ...
    session.execute("CREATE TABLE IF NOT EXISTS ks.users (user_id uuid PRIMARY KEY, name text, address frozen<address>);");
    ...
    //TODO Exception trying to get
    //User uget = mapper.get(userId.toJavaUUID());
    
    mapper.delete(userId.toJavaUUID());
